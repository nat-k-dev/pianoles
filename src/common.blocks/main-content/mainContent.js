...
const MainContent = () => {
    return (
        <main className='main__main-content main-content main-content_background_light'>
          <figure>
              <a href="https://www.freepik.com/free-photo/look-from-mother-daughter-playing-white-piano_1120622.htm#query=woman%20playing%20piano&position=1&from_view=keyword" target="_blank" rel="noopener noreferrer">
              ...
              <figcaption className="main-content__image-caption image-caption image-caption_text_small image-caption_text_italic">
                <Trans i18nKey="figcaption_img_caption">
                  Piano lessons for adults and children, image by v.ivash
                </Trans>
              </figcaption>
          </figure>
